...
class PropertyController extends Controller
{
    ...
    public function getPropertyAction(Request $request, $id) {
        ...
        if ($uid != "anon.")
            $uid->getId();
        // end calling review bundle

        return $this->render("PropertyBundle:Property:detail.html.twig",array('logement'=>$logement,'user'=>$this->getUser(), 'reviews' => $reviews, 'add_review' => $add_review_call, "uid" => $uid));
    }
