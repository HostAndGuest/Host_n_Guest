...
class ReviewController extends Controller
{
    ...
    */
    public function getReviewsAction($pid, Request $request)
    {
        ...
        $reviews = $em->getRepository('ReviewBundle:Review')->getReviewsOfProperty($pid);

        $paginator  = $this->get('knp_paginator');

        /*
         * instead of giving page and limit a static value we use the request
         * static value would mean this would go off and pull back the entire dataset - all 1 million rows (for example) - t
         * hen pass them into the paginator which would slice and dice them and give us the tiny portion of records we actually wanted.
         ...
         */
        /*
         * query is a ParameterBag (container of key / values)
         */
